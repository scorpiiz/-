	...
	try 
	{
		   ...
		   else 
		   {
               ...
               //{
				   ...
				   System.out.println("新文件名称路径："+saveurl);
	  ...
	  {
	    e.toString();
	    System.out.println("新文件名称路径："+e.toString());
	  }
%>

<script language="javascript">
    document.write("上传成功");
	window.parent.document.getElementById("<%= request.getParameter("cc")%>").value="/upload/<%= newFile1Name%>";
</script>

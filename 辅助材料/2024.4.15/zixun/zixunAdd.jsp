...
<main class="ftdms-layout-content">
	 ...
	 <ul class="nav nav-tabs page-tabs">             
	    <li class="active"> <a href="#">添加宠物知识</a> </li>           
	 </ul>
	 ...
	 <div class="tab-pane active">
                			...
                			<form  action="<%=path %>/zixunAdd.action" method="post" id="form1">
                		 <table style="width: 100%;" >
                    <tr>
<td  style=" text-align:right; width:20%;"><font style='color:red'>*&nbsp;</font>标题:</td>
<td class="tbright"><div style="display:inline;float:left;"><input name="bt" type="text" id="bt" style="width: 200px; " required  /></div>
</td></tr>
<tr>
<td  style=" text-align:right; width:20%;">图片:</td>
<td class="tbright"><div style="display:inline;float:left;"><input type="text" name="pic" id="pic" size="50" readonly="readonly"  />
<input type="button" value="上传" onclick="up2('pic')" /></div>
</td></tr>
<tr>
<td  style=" text-align:right; width:20%;">内容:</td>
<td class="tbright"><div style="display:inline;float:left;"><textarea name="bz" id="bz" cols="100" rows="8" style="width:700px;height:400px;visibility:hidden;"   ></textarea></div>
</td></tr>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td align="left">
                		      <input type="submit" name="btnAdd" value="添 加"  id="btnAdd"    class="btn btn-primary" />
